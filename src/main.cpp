...
unsigned int nStakeMinAge = 1 * 24 * nOneHour; // 30 days as zero time weight
...
const string strMessageMagic = "WineCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("WineCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in WineCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // WineCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WineCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "winecoin Genesis";
        CTransaction txNew;
        txNew.nTime = 1470105717;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1470105717;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 944025; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xba, 0xf2, 0xe3, 0xf5 };
