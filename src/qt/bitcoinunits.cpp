...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("wine");
    case mBTC: return QString("mwine");
    case uBTC: return QString::fromUtf8("μwine");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("WineCoins"));
    case mBTC: return QString(QObject::tr("Milli-WineCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-WineCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
